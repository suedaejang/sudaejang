<template>
  <div class="totalBox" style="height: 782px; width: 899px; top: -15px">
    <div class="totalInfo">
      <div class="nameRow">
        <div class="col p-3">
          <h2>가계부 등록</h2>
      ...
      <div class="infoRow">
        <div class="col">
          <div class="form-group">
            <label
              :class="{
                required: !transaction.category1,
              }"
              for="inNout"
            >
              입출금 구분</label
          ...
          <div class="form-group">
            <label
              :class="{
                required: !transaction.category2,
              }"
              for="cate"
              >카테고리</label
            >
        ...
        <div class="btnGroup">
          <button type="button" @click="cancleTransaction">취소</button>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <button type="button" @click="saveTransaction">저장</button>
        </div>
      </div>
    </div>
  </div>
...
const cancleTransaction = () => {
  const userConfirmed = confirm('등록을 취소하시겠습니까?');
  if (userConfirmed) {
    router.push('/');
  }
};
